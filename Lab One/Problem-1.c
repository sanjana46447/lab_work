/*.Arif's basic salary is input through the keyboard. His dearness allowance is 40% of his basic
...
printf("Enter Arif's basic salary : ");
...
printf("Arif's Gross salary is %.2lf \n",Gross_salary);
